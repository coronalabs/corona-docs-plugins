...
_[Integer][api.type.Integer]._ Unique error code, present when [event.isError][plugin.gpgs2.multiplayer.realtime.event.showSelectPlayers.isError] is `true`, `nil` otherwise..