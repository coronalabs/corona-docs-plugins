...
_[Integer][api.type.Number]._ Unique error code, present when [event.isError][plugin.gpgs-v2.multiplayer.realtime.event.showSelectPlayers.isError] is `true`, `nil` otherwise..